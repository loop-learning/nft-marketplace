...
const NFTModal = ({ nft, isOpen, setIsOpen, onClose }) => {
  ...
  const { purchaseListing, cancelListing, makeOffer, acceptOffer, endAuction, isExpired, formatPrice, useOffersForNFT, isConfirmed, isConfirming, isPending, error } = useMarketplace()
            ...
            <div className="bg-gray-700 rounded-lg p-4">
              ...
              {!isConnected ? (
                ...
                <div className="space-y-2">
                  ...
                  {!nft.isFixed && (
                    <button
                      onClick={() => console.log('Place Bid clicked for NFT:', nft.name)}
